...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView mIndexView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIndexView = (AutoCompleteTextView) findViewById(R.id.index);
...
//        databaseHelper.insertConnector();
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mIndexView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        // Reset errors.
        mIndexView.setError(null);
        mPasswordView.setError(null);

        // Store values at the time of the login attempt.
        String temp_index = mIndexView.getText().toString();
        ...
        if (!TextUtils.isEmpty(temp_password) && !isPasswordValid(temp_password)) {
            focusView = mPasswordView;
            cancel = true;
        }

        // Check for a valid email address.
        if (TextUtils.isEmpty(temp_index)) {
            mIndexView.setError(getString(R.string.error_field_required));
            focusView = mIndexView;
            cancel = true;
        } else if (!isIndexValid(temp_index)) {
            mIndexView.setError(getString(R.string.error_invalid_index));
            focusView = mIndexView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            if(databaseHelper.checkUser(temp_index,temp_password)) {
                ...
                Toast.makeText(getApplicationContext(), "Podano błędne dane logowania", Toast.LENGTH_LONG).show();
//            showProgress(false);
//            mAuthTask = new UserLoginTask(index, password);
